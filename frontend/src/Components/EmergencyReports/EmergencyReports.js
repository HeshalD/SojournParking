...
const EmergencyReports = () => {
    ...
    const fetchReports = async () => {
        try {
            ...
            try {
                console.log('Fetching medical reports from: http://localhost:4000/MedIssues/');
                const medResponse = await axios.get('http://localhost:4000/MedIssues/');
            ...
            try {
                console.log('Fetching mechanical reports from: http://localhost:4000/MecIssues/');
                const mecResponse = await axios.get('http://localhost:4000/MecIssues/');
            ...
            try {
                console.log('Fetching security reports from: http://localhost:4000/SecIssues/');
                const secResponse = await axios.get('http://localhost:4000/SecIssues/');
